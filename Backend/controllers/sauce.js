...
// Renvoie de la liste complète concernant toutes les sauces dans la base de données (Get)
...
// Renvoie d'une seule sauce avec son ID (Get/:id)
...
// Création d'une instance du modèle sauce en ayant supprimé le faux _id (Post)
...
exports.modifySauce = (req, res, next) => {
  const sauceObject = req.file ?
    ...
    // Si il n'y a pas d'image, updateone met à jour le sauce qui correspond à l'objet pasé en premier argument
